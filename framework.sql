...
CREATE TABLE `babysitter` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='保姆表';
...
CREATE TABLE `category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='服务项目分类表';
...
CREATE TABLE `items` (
  ...
  `payment_method` enum('0','1') NOT NULL DEFAULT '0' COMMENT '付款方式',
  `status` enum('0','1') NOT NULL DEFAULT '0' COMMENT '项目状态0：启用，1：禁用',
  PRIMARY KEY (`id`)
...
INSERT INTO `permissions` VALUES ('3', 'ccc', '测试3', '测试3', '', '0', '2', '1');
