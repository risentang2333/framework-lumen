...
CREATE TABLE `items`  (
  ...
  `payment_method` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '付款方式',
  `status` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '项目状态0：启用，1：禁用',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of managers
-- ----------------------------
INSERT INTO `managers` VALUES (1, 'aaa', '123456', '唐朝', '8af4d92f590b36d45d09bc2d443d868b', '', 0);
...
INSERT INTO `permission_role` VALUES (4, 4, 2);
...
CREATE TABLE `permissions`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `route` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '前端路由',
...
-- ----------------------------
INSERT INTO `permissions` VALUES (1, 'aaa', '测试', '测试', '', 0, 0, 1);
INSERT INTO `permissions` VALUES (2, 'bbb', '测试2', '测试2', '', 0, 0, 1);
INSERT INTO `permissions` VALUES (3, 'permission/getMenu', '测试3', '测试3', '', 0, 2, 1);
INSERT INTO `permissions` VALUES (4, 'ddd', '测试4', '测试4', '', 3, 3, 1);
INSERT INTO `permissions` VALUES (5, 'eee', '测试5', '测试5', '', 1, 3, 1);
INSERT INTO `permissions` VALUES (6, 'fff', '测试6', '测试6', '', 2, 3, 1);
INSERT INTO `permissions` VALUES (7, 'ggg', '测试7', '测试7', '', 0, 2, 1);
INSERT INTO `permissions` VALUES (8, 'hhh', '测试8', '测试8', '', 1, 2, 1);
...
INSERT INTO `role_manager` VALUES (2, 1, 2);
...
-- Records of roles
-- ----------------------------
INSERT INTO `roles` VALUES (1, '角色1');
INSERT INTO `roles` VALUES (2, '角色2');
